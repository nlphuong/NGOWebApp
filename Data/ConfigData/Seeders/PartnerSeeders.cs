    ...
    public class PartnerSeeders
    {
        public PartnerSeeders(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Partner>().HasData(
                new Partner() {Id=1,OrgName= "Crescent Moon Charity & Social Protection Fund", Email= "Charity@gmail.com", Phone= "0925695555", Address= "Viet Nam", CategoryId=1,Logo= "fe4d2fad-7ff7-420e-a462-b22a61cde107.jpg" },
